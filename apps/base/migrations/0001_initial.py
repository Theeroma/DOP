    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(upload_to='logo_image', verbose_name='Логотип сайта')),
                ...
                ('instagram', models.URLField(blank=True, null=True, verbose_name='Ссылка на инстаграмм')),
